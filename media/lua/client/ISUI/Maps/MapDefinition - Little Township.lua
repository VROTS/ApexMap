...
LootMaps.Init.LittleTownshipLootableMap = function(mapUI)
    local mapAPI = mapUI.javaObject:getAPIv1()
    MapUtils.initDirectoryMapData(mapUI, 'media/maps/LittleTownship')
    MapUtils.initDefaultStyleV1(mapUI)
    replaceWaterStyle(mapUI)
	mapAPI:setBoundsInSquares(8100, 8400, 8400, 8700)
	-- overlayPNG(mapUI, 8175, 8475, 0.666, "legend", "media/ui/LootableMaps/Legend_50.png")
