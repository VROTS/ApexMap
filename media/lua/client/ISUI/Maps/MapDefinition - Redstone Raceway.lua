...
LootMaps.Init.RedstoneRacewayLootableMap = function(mapUI)
    local mapAPI = mapUI.javaObject:getAPIv1()
    MapUtils.initDirectoryMapData(mapUI, 'media/maps/RedstoneRaceway')
    MapUtils.initDefaultStyleV1(mapUI)
    replaceWaterStyle(mapUI)
	mapAPI:setBoundsInSquares(12000, 10800, 12300, 11400)
	-- overlayPNG(mapUI, 9025, 11125, 0.666, "legend", "media/textures/worldMap/Legend.png")
