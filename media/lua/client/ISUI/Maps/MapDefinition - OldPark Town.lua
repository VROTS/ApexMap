...
LootMaps.Init.OldParkTownLootableMap = function(mapUI)
    local mapAPI = mapUI.javaObject:getAPIv1()
    MapUtils.initDirectoryMapData(mapUI, 'media/maps/OldParkTown')
    MapUtils.initDefaultStyleV1(mapUI)
    replaceWaterStyle(mapUI)
	mapAPI:setBoundsInSquares(8700, 8700, 9000, 9000)
	overlayPNG(mapUI, 8725, 8725, 0.666, "legend", "media/Lootmaps/Legend_50.png")
