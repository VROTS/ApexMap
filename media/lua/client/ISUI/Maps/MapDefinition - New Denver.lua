...
LootMaps.Init.NewDenverLootableMap = function(mapUI)
    local mapAPI = mapUI.javaObject:getAPIv1()
    MapUtils.initDirectoryMapData(mapUI, 'media/maps/NewDenver')
    MapUtils.initDefaultStyleV1(mapUI)
    replaceWaterStyle(mapUI)
	mapAPI:setBoundsInSquares(2100, 16000, 3700, 17925)
	-- overlayPNG(mapUI, 0, 0, 1, "lootMapPNG", "media/ui/LootableMaps/nomap_lootmap.png")
