...
LootMaps.Init.ChernavilleLootableMap = function(mapUI)
    local mapAPI = mapUI.javaObject:getAPIv1()
    MapUtils.initDirectoryMapData(mapUI, 'media/maps/Chernaville')
    MapUtils.initDefaultStyleV1(mapUI)
    replaceWaterStyle(mapUI)
	mapAPI:setBoundsInSquares(9600, 10200, 9900, 10800)
	overlayPNG(mapUI, 9625, 10225, 0.666, "legend", "media/Lootmaps/Legend_50.png")
