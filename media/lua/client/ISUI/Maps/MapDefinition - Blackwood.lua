...
LootMaps.Init.BlackwoodLootableMap = function(mapUI)
    local mapAPI = mapUI.javaObject:getAPIv1()
    MapUtils.initDirectoryMapData(mapUI, 'media/maps/Blackwood')
    MapUtils.initDefaultStyleV1(mapUI)
    replaceWaterStyle(mapUI)
	mapAPI:setBoundsInSquares(7800, 10500, 8100, 10800)
	-- overlayPNG(mapUI, 7875, 10575, 0.666, "legend", "media/textures/worldMap/Legend.png")
