...
LootMaps.Init.RabbitHashLootableMap = function(mapUI)
    local mapAPI = mapUI.javaObject:getAPIv1()
    MapUtils.initDirectoryMapData(mapUI, 'media/maps/RabbitHashKY')
    MapUtils.initDefaultStyleV1(mapUI)
    replaceWaterStyle(mapUI)
    mapAPI:setBoundsInSquares(9000, 7200, 9599, 7499)
    -- overlayPNG(mapUI, 9010, 7210, 0.666, "badge", "media/textures/worldMap/RabbitHashBadge.png")
    -- overlayPNG(mapUI, 9011, 7260, 0.666, "legend", "media/textures/worldMap/RabbitHashLegend.png")
