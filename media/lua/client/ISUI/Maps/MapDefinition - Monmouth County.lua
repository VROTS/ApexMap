...
LootMaps.Init.MonmouthCountyLootableMap = function(mapUI)
    local mapAPI = mapUI.javaObject:getAPIv1()
    MapUtils.initDirectoryMapData(mapUI, 'media/maps/MonmouthCounty')
    MapUtils.initDefaultStyleV1(mapUI)
    replaceWaterStyle(mapUI)
    mapAPI:setBoundsInSquares(11460, 8100, 12059, 8699)
    -- overlayPNG(mapUI, 11999, 8100, 0.401, "badge", "media/textures/worldMap/MonmouthCountyBadge.png")
    -- overlayPNG(mapUI, 11465, 8400, 0.401, "legend", "media/textures/worldMap/Legend.png")
