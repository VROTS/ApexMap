...
LootMaps.Init.MarchRidgeExpansionLootableMap = function(mapUI)
    local mapAPI = mapUI.javaObject:getAPIv1()
    MapUtils.initDirectoryMapData(mapUI, 'media/maps/MarchRidgeExpansion')
    MapUtils.initDefaultStyleV1(mapUI)
    replaceWaterStyle(mapUI)
	mapAPI:setBoundsInSquares(9600, 12600, 9900, 12900)
	overlayPNG(mapUI, 9625, 12625, 0.666, "legend", "media/Lootmaps/Legend_50.png")
