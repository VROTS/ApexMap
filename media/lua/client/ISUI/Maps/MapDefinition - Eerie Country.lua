...
LootMaps.Init.EerieALootableMap = function(mapUI)
    local mapAPI = mapUI.javaObject:getAPIv1()
    MapUtils.initDirectoryMapData(mapUI, 'media/maps/EerieCountry')
    MapUtils.initDefaultStyleV1(mapUI)
    replaceWaterStyle(mapUI)
    mapAPI:setBoundsInSquares(0, 0, 2499, 2499)
	overlayPNG(mapUI, 0, 0, 1, "lootMapPNG", "media/ui/LootableMaps/EerieA.png")
    MapUtils.overlayPaper(mapUI)
end

LootMaps.Init.EerieBLootableMap = function(mapUI)
    local mapAPI = mapUI.javaObject:getAPIv1()
    MapUtils.initDirectoryMapData(mapUI, 'media/maps/EerieCountry')
    MapUtils.initDefaultStyleV1(mapUI)
    replaceWaterStyle(mapUI)
    mapAPI:setBoundsInSquares(0, 0, 2499, 2499)
	overlayPNG(mapUI, 0, 0, 1, "lootMapPNG", "media/ui/LootableMaps/EerieB.png")
    MapUtils.overlayPaper(mapUI)
end

LootMaps.Init.EerieCLootableMap = function(mapUI)
    local mapAPI = mapUI.javaObject:getAPIv1()
    MapUtils.initDirectoryMapData(mapUI, 'media/maps/EerieCountry')
    MapUtils.initDefaultStyleV1(mapUI)
    replaceWaterStyle(mapUI)
    mapAPI:setBoundsInSquares(0, 0, 2499, 2499)
	overlayPNG(mapUI, 0, 0, 1, "lootMapPNG", "media/ui/LootableMaps/EerieC.png")
    MapUtils.overlayPaper(mapUI)
end

LootMaps.Init.EerieDLootableMap = function(mapUI)
    local mapAPI = mapUI.javaObject:getAPIv1()
    MapUtils.initDirectoryMapData(mapUI, 'media/maps/EerieCountry')
    MapUtils.initDefaultStyleV1(mapUI)
    replaceWaterStyle(mapUI)
    mapAPI:setBoundsInSquares(0, 0, 2499, 2499)
	overlayPNG(mapUI, 0, 0, 1, "lootMapPNG", "media/ui/LootableMaps/EerieD.png")
    MapUtils.overlayPaper(mapUI)
end
...
LootMaps.Init.EerieALootableMap = function(mapUI)
    ...
    MapUtils.initDefaultStyleV1(mapUI)
    replaceWaterStyle(mapUI)
rem	mapAPI:setBoundsInSquares(25x300, 45x300, 32x300+299, 52x300+299)
	mapAPI:setBoundsInSquares(0, 0, 2499, 2499)
	overlayPNG(mapUI, 0, 0, 1, "lootMapPNG", "media/ui/LootableMaps/EerieA.png")
    MapUtils.overlayPaper(mapUI)
end
...
LootMaps.Init.EerieBLootableMap = function(mapUI)
    ...
    MapUtils.initDefaultStyleV1(mapUI)
    replaceWaterStyle(mapUI)
    mapAPI:setBoundsInSquares(33x300, 45x300, 40x300+299, 52x300+299)
rem	mapAPI:setBoundsInSquares(0, 0, 2499, 2499)
rem	overlayPNG(mapUI, 0, 0, 1, "lootMapPNG", "media/ui/LootableMaps/EerieB.png")
    MapUtils.overlayPaper(mapUI)
end
...
LootMaps.Init.EerieCLootableMap = function(mapUI)
    ...
    MapUtils.initDefaultStyleV1(mapUI)
    replaceWaterStyle(mapUI)
    mapAPI:setBoundsInSquares(25x300, 53x300, 32x300+299, 60x300+299)
rem	mapAPI:setBoundsInSquares(0, 0, 2499, 2499)
rem	overlayPNG(mapUI, 0, 0, 1, "lootMapPNG", "media/ui/LootableMaps/EerieC.png")
    MapUtils.overlayPaper(mapUI)
end
...
LootMaps.Init.EerieDLootableMap = function(mapUI)
    ...
    MapUtils.initDefaultStyleV1(mapUI)
    replaceWaterStyle(mapUI)
	mapAPI:setBoundsInSquares(33x300, 53x300, 40x300+299, 60x300+299)
rem	mapAPI:setBoundsInSquares(0, 0, 2499, 2499)
rem	overlayPNG(mapUI, 0, 0, 1, "lootMapPNG", "media/ui/LootableMaps/EerieD.png")
    MapUtils.overlayPaper(mapUI)
end
]]