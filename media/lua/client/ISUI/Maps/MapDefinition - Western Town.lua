...
LootMaps.Init.WesternTownLootableMap = function(mapUI)
    local mapAPI = mapUI.javaObject:getAPIv1()
    MapUtils.initDirectoryMapData(mapUI, 'media/maps/WesternTown')
    MapUtils.initDefaultStyleV1(mapUI)
    replaceWaterStyle(mapUI)
	mapAPI:setBoundsInSquares(11700, 7200, 11999, 7499)
	-- overlayPNG(mapUI, 4525, 6625, 0.666, "legend", "media/Lootmaps/Legend_50.png")
