...
LootMaps.Init.GreenleafLootableMap = function(mapUI)
    local mapAPI = mapUI.javaObject:getAPIv1()
    MapUtils.initDirectoryMapData(mapUI, 'media/maps/Greenleaf')
    MapUtils.initDefaultStyleV1(mapUI)
    replaceWaterStyle(mapUI)
	mapAPI:setBoundsInSquares(6300, 10200, 6900, 10500)
	overlayPNG(mapUI, 6325, 10225, 0.666, "legend", "media/Lootmaps/Legend_50.png")
