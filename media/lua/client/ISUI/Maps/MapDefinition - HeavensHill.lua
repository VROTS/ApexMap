...
LootMaps.Init.HeavensHillLootableMap = function(mapUI)
    local mapAPI = mapUI.javaObject:getAPIv1()
    MapUtils.initDirectoryMapData(mapUI, 'media/maps/HeavensHill')
    MapUtils.initDefaultStyleV1(mapUI)
    replaceWaterStyle(mapUI)
	mapAPI:setBoundsInSquares(7500, 7800, 7800, 8100)
	-- overlayPNG(mapUI, 11125, 8125, 0.666, "legend", "media/Lootpacks/Legend_50.png")
