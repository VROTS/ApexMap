...
LootMaps.Init.GrapeseedLootableMap = function(mapUI)
    local mapAPI = mapUI.javaObject:getAPIv1()
    MapUtils.initDirectoryMapData(mapUI, 'media/maps/Grapeseed')
    MapUtils.initDefaultStyleV1(mapUI)
    replaceWaterStyle(mapUI)
	mapAPI:setBoundsInSquares(7200, 11100, 7500, 11400)
	-- overlayPNG(mapUI, 7250, 11250, 0.666, "legend", "media/textures/worldMap/Legend_50.png")
