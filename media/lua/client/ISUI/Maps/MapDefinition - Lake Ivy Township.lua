...
LootMaps.Init.LakeIvyTownshipLootableMap = function(mapUI)
    local mapAPI = mapUI.javaObject:getAPIv1()
    MapUtils.initDirectoryMapData(mapUI, 'media/maps/LakeIvyTownship')
    MapUtils.initDefaultStyleV1(mapUI)
    replaceWaterStyle(mapUI)
	mapAPI:setBoundsInSquares(0, 0, 840, 909)
	overlayPNG(mapUI, 0, 0, 1, "lootMapPNG", "media/ui/LootableMaps/LakeIvyTownship.png")
