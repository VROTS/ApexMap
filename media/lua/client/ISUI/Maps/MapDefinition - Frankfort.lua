...
LootMaps.Init.FrankfortLootableMap = function(mapUI)
    local mapAPI = mapUI.javaObject:getAPIv1()
    MapUtils.initDirectoryMapData(mapUI, 'media/maps/Frankfort')
    MapUtils.initDefaultStyleV1(mapUI)
    replaceWaterStyle(mapUI)
	mapAPI:setBoundsInSquares(3300, 7800, 3900, 8100)
	-- overlayPNG(mapUI, 3225, 7707, 0.666, "legend", "media/textures/worldMap/Legend_50.png")
