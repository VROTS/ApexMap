...
LootMaps.Init.ChinatownLootableMap = function(mapUI)
    local mapAPI = mapUI.javaObject:getAPIv1()
    MapUtils.initDirectoryMapData(mapUI, 'media/maps/Chinatown')
    MapUtils.initDefaultStyleV1(mapUI)
    replaceWaterStyle(mapUI)
	mapAPI:setBoundsInSquares(11100, 8700, 11400, 9300)
	overlayPNG(mapUI, 11125, 8725, 0.666, "legend", "media/Lootmaps/Legend_50.png")
