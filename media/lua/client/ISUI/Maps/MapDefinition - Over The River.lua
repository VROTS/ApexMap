...
LootMaps.Init.OverTheRiverLootableMap = function(mapUI)
    local mapAPI = mapUI.javaObject:getAPIv1()
    MapUtils.initDirectoryMapData(mapUI, 'media/maps/OverTheRiver')
    MapUtils.initDefaultStyleV1(mapUI)
    replaceWaterStyle(mapUI)
	mapAPI:setBoundsInSquares(11100, 5600, 12000, 6600)
	overlayPNG(mapUI, 11110, 5610, 0.666, "legend", "media/Lootmaps/Legend_50.png")
	-- 565 x 468 
