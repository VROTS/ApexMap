...
LootMaps.Init.NewEkronLootableMap = function(mapUI)
    local mapAPI = mapUI.javaObject:getAPIv1()
    MapUtils.initDirectoryMapData(mapUI, 'media/maps/NewEkron')
    MapUtils.initDefaultStyleV1(mapUI)
    replaceWaterStyle(mapUI)
	mapAPI:setBoundsInSquares(6900, 8100, 7500, 8700)
	-- overlayPNG(mapUI, 6910, 8110, 0.666, "legend", "media/Lootmaps/Legend_50.png")
